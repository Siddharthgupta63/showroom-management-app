...
export default function Sidebar() {
 ...
 const canPurchases =
  ...
  const canPermissions = isOwnerAdmin || hasPermission("manage_permissions");
  const canDropdowns = isOwnerAdmin || hasPermission("manage_dropdowns");

  // show Users section if any admin tools are available
  const canAdminSection = canPermissions || canDropdowns;
  ...
  return (
    <aside className="w-64 bg-red-600 text-white min-h-screen flex flex-col">
